...
public class CubeRotation extends Frame
{  public static void main(String[] args){new CubeRotation();}
...
class CvCubeRotation extends Canvas
   implements Runnable
...
{   float rho, theta=0F, phi=1.3F, d;
    ...
    { s = new Point3D[16]; // Start situation
      ...
      // s[0] = new Point3D( 1, −3, −1);
        s[0] = new Point3D( 1, -3, -1);
      s[1] = new Point3D( 1, -1, -1); // s[1] = new Point3D( 1, −1, −1);
       s[2] = new Point3D( -1, -1, -1);// s[2] = new Point3D(−1, −1, −1);
        s[3] = new Point3D( -1, -3, -1);//s[3] = new Point3D(−1, −3, −1);
       // Top surface:
       s[4] = new Point3D( 1, -3, 1);// s[4] = new Point3D( 1, −3,  1);
        s[5] = new Point3D( 1, -1, 1);//s[5] = new Point3D( 1, −1,  1);
        s[6] = new Point3D( -1, -1, 1); //s[6] = new Point3D(−1, −1,  1);
        s[7] = new Point3D( -1, -3, 1); //s[7] = new Point3D(−1, −3,  1);
       // Bottom surface:
       s[8] = new Point3D( 1, 1, -1);// s[8]  = new Point3D( 1,  1, −1);
        s[9] = new Point3D( 1, 3, -1);//s[9]  = new Point3D( 1,  3, −1);
       s[10] = new Point3D( -1, 3, -1);// s[10] = new Point3D(−1,  3, −1);
       s[11] = new Point3D( -1, 1, -1);// s[11] = new Point3D(−1,  1, −1);
       // Top surface:
       s[12] = new Point3D( 1, 1, 1);//s[12] = new Point3D( 1,  1,  1);
       s[13] = new Point3D( 1, 3, 1);//s[13] = new Point3D( 1,  3,  1);
     s[14] = new Point3D( -1, 3, 1);// s[14] = new Point3D(−1,  3,  1);
      s[15] = new Point3D( -1, 1, 1);// s[15] = new Point3D(−1,  1,  1);
    ...
    void rotateCube(double alpha)
            {  Point3D a = s[0] ;
               Point3D b = s[4] ;
                        Rota3D.initRotate(a,b, alpha)  ;//Rota3D.initRotate(s[0], s[4], alpha);
               for (int i=0; i<8; i++)
              ...
              Rota3D.initRotate(c, d, (2*alpha));// Rota3D.initRotate(s[13], s[9], 2 * alpha);
               for (int i=8; i<16; i++)
                 w[i] =Rota3D.rotate(s[i]); //w[i] = Rota3D.rotate(s[i]);
    }
